...
|The scatter plot is plotted quarter lengthn against pitch. According to the graph, the data regarding pitch is consistent with the last graph and the analysis from jSymbolic, with B5 appearing to be the most common pitch throughout the song. |<p align="center"><img src="https://github.com/chenjcharlotte/MCA-2020/blob/master/images/week4myScatterPlot.png" width="2500"></P>|
|There are 37 measures in total and I decided to analyse the entire piece I transribed. Again, the results align with the previous analysis. |<p align="center"><img src="https://github.com/chenjcharlotte/MCA-2020/blob/master/images/week4noteQuarterLengthByPitch.png" width="2500"></P>|
